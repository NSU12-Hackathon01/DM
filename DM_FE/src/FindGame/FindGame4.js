...
function FindGame({ onGameEnd }) {
    const [editedImageSrc, setEditedImageSrc] = useState('/images/find/틀그5-2.jpg');
        ...
        <div className="find-difference-game">
            ...
            <div className="image-container">
                <div className="image-wrapper">
                    <h2>원본 그림</h2>
                    <img src="/images/find/틀그5-1.jpg" alt="Original" className="game-image" />
                </div>
                <div className="image-wrapper">
                    <h2>달라진 그림</h2>
                    <div className="image-overlay" onClick={handleCanvasClick}>
                        <img src={editedImageSrc} alt="Edited" className="game-image" />
                        <button className="overlay-button btn3-1" style={{ top: '235px', left: '40px' }} onClick={(e) => handleButtonClick(e, 0)}></button>
                        <button className="overlay-button btn3-2" style={{ top: '220px', left: '170px' }} onClick={(e) => handleButtonClick(e, 1)}></button>
                        <button className="overlay-button btn4-3" style={{ top: '100px', left: '310px' }} onClick={(e) => handleButtonClick(e, 2)}></button>
