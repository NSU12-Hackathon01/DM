...
function FindGame({ onGameEnd }) {
    const [editedImageSrc, setEditedImageSrc] = useState('/images/find/틀그3-2.jpg');
        ...
        <div className="find-difference-game">
            ...
            <div className="image-container">
                <div className="image-wrapper">
                    <h2>원본 그림</h2>
                    <img src="/images/find/틀그3-1.jpg" alt="Original" className="game-image" />
                </div>
                <div className="image-wrapper">
                    <h2>달라진 그림</h2>
                    <div className="image-overlay" onClick={handleCanvasClick}>
                        <img src={editedImageSrc} alt="Edited" className="game-image" />
                        <button className="overlay-button btn2-1" style={{ top: '25px', left: '60px' }} onClick={(e) => handleButtonClick(e, 0)}></button>
                        <button className="overlay-button btn2-2" style={{ top: '150px', left: '360px' }} onClick={(e) => handleButtonClick(e, 1)}></button>
                        <button className="overlay-button btn2-3" style={{ top: '230px', left: '320px' }} onClick={(e) => handleButtonClick(e, 2)}></button>
