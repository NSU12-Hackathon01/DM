  ...
  return (
    <div className="TNumgame">
      <div className='EXtest'>
        <ul>
          <li>
            <img src='/images/과일 산수 문제/5.jpg' alt='문제 1' />
          </li>
          <li>
            <img src='/images/과일 산수 문제/6.jpg' alt='문제 2' />
          </li>
          <li>
            <img src='/images/과일 산수 문제/5-1.jpg' alt='문제 3' />
          </li>
          <li>
            <img src='/images/과일 산수 문제/6-1.jpg' alt='문제 4' />
          </li>
          <li>
            <img src='/images/과일 산수 문제/5-2.jpg' alt='문제 4' />
          </li>
          <li>
            <img src='/images/과일 산수 문제/6-2.jpg' alt='문제 4' />
          </li>
          <li className='num_result'>
            ...
            <span>
              <img src='/images/과일 산수 문제/포도답-.jpg' alt='사과 답' />
              <input
                type='text'
                value={inputValue2}
            ...
            <span>
              <img src='/images/과일 산수 문제/옥수수답-.jpg' alt='포도 답' />
              <input
                type='text'
                value={inputValue3}
