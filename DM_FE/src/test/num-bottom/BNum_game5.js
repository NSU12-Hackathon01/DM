...
function TNum_game({ updateResult }) {
  ...
  return (
    <div className="TNumgame">
      <div className='EXtest'>
        <ul>
          <li>
            <img src='/images/과일 산수 문제/9.jpg' alt='문제 1' />
          </li>
          <li>
            <img src='/images/과일 산수 문제/10.jpg' alt='문제 2' />
          </li>
          <li>
            <img src='/images/과일 산수 문제/9-1.jpg' alt='문제 3' />
          </li>
          <li>
            <img src='/images/과일 산수 문제/10-1.jpg' alt='문제 4' />
          </li>
          <li>
            <img src='/images/과일 산수 문제/9-2.jpg' alt='문제 4' />
          </li>
          <li>
            <img src='/images/과일 산수 문제/10-2.jpg' alt='문제 4' />
          </li>
          <li className='num_result'>
            <span>
              <img src='/images/과일 산수 문제/딸기답-.jpg' alt='당근 답' />
              <input
                type='text'
                value={inputValue1}
            ...
            <span>
              <img src='/images/과일 산수 문제/당근답-.jpg' alt='사과 답' />
              <input
                type='text'
                value={inputValue2}
            ...
            <span>
              <img src='/images/과일 산수 문제/포도답-.jpg' alt='포도 답' />
              <input
                type='text'
                value={inputValue3}
            ...
            <span>
              <img src='/images/과일 산수 문제/사과답-.jpg' alt='포도 답' />
              <input
                type='text'
                value={inputValue4}
