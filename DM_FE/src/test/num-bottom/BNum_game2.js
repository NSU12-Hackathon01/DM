  ...
  return (
    <div className="TNumgame">
      <div className='EXtest'>
        <ul>
          <li>
            <img src='/images/과일 산수 문제/3.jpg' alt='문제 1' />
          </li>
          <li>
            <img src='/images/과일 산수 문제/4.jpg' alt='문제 2' />
          </li>
          <li>
            <img src='/images/과일 산수 문제/3-1.jpg' alt='문제 3' />
          </li>
          <li>
            <img src='/images/과일 산수 문제/4-1.jpg' alt='문제 4' />
          </li>
          <li>
            <img src='/images/과일 산수 문제/3-2.jpg' alt='문제 4' />
          </li>
          <li>
            <img src='/images/과일 산수 문제/4-2.jpg' alt='문제 4' />
          </li>
          <li className='num_result'>
            ...
            <span>
              <img src='/images/과일 산수 문제/딸기답-.jpg' alt='포도 답' />
              <input
                type='text'
                value={inputValue3}
