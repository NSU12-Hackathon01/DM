...
function FindGame({ updateResult }) {
    const [editedImageSrc, setEditedImageSrc] = useState('/images/find/틀그6-2.png');
                ...
                <>
                    ...
                    <div className="image-container">
                        <div className="image-wrapper">
                            <h2>원본 그림</h2>
                            <img src="/images/find/틀그6-1.png" alt="Original" className="game-image" />
                        </div>
                        <div className="image-wrapper">
                            <h2>달라진 그림</h2>
                            <div className="image-overlay" onClick={handleCanvasClick}>
                                <img src={editedImageSrc} alt="Edited" className="game-image" />
                                <button className="overlay-button btn5-1" style={{ top: '135px', left: '40px' }} onClick={(e) => handleButtonClick(e, 0)}></button>
                                <button className="overlay-button btn5-2" style={{ top: '220px', left: '0px' }} onClick={(e) => handleButtonClick(e, 1)}></button>
                                <button className="overlay-button btn5-3" style={{ top: '145px', left: '275px' }} onClick={(e) => handleButtonClick(e, 2)}></button>
