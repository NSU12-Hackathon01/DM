import './Mnum_game.css';
import React, { useState } from 'react';

function MNum_game({ updateResult }) {
      ...
      <div className='Mtest'>
        <ul>
          ...
          <li className='num_result'>
            <span>
              <img src='/images/과일 산수 문제/옥수수답-.jpg' alt='당근 답' />
              <input
                type='text'
                value={inputValue1}
            ...
            <span>
              <img src='/images/과일 산수 문제/딸기답-.jpg' alt='사과 답' />
              <input
                type='text'
                value={inputValue2}
            ...
            <span>
              <img src='/images/과일 산수 문제/레몬답-.jpg' alt='포도 답' />
              <input
                type='text'
                value={inputValue3}
