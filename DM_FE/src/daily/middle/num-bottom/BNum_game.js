  ...
  return (
    <div className="MNumgame">
      <div className='Mtest'>
        <ul>
          <li>
            <img src='/images/과일 산수 문제/1.jpg' alt='문제 1' />
          </li>
          <li>
            <img src='/images/과일 산수 문제/2.jpg' alt='문제 2' />
          </li>
          <li>
            <img src='/images/과일 산수 문제/1-1.jpg' alt='문제 3' />
          </li>
          <li>
            <img src='/images/과일 산수 문제/2-1.jpg' alt='문제 4' />
          </li>
          <li className='num_result'>
            <span>
              <img src='/images/과일 산수 문제/당근답-.jpg' alt='당근 답' />
              <input
                type='text'
                value={inputValue1}
