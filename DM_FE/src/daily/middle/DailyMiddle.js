    ...
    return (
        <div className='Mall'>
            ...
            <div className='dailyMiddle'>
                <div className='dailyMiddle_wrap'>
                    <Slider {...settings}>
                        <div>
                        ...
                        <div className='dailyMiddleResult'>
                            <h2>점수 요약</h2>
                           ...
                           <div className='bottomresult'>
                            ...
                            <Link  to = '/'><button className='dailycheck'>출석체크 하기</button></Link>
                        </div>
                    </Slider>
                </div>
            </div><style jsx>{`
