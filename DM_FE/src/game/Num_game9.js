...
function Num_game9({ updateResult }) {
    ...
    <div className="Numgame">
      <div className='test'>
        <ul>
          ...
          <li>
          <img src='/images/과일 산수 문제/9-1.jpg' alt='문제 1-1' />
          </li>
          <li>
          <img src='/images/과일 산수 문제/9-2.jpg' alt='문제 1-2' />
          </li>
          <li className='num_result'>
            ...
            <span>
            <img src='/images/과일 산수 문제/딸기답-.jpg' alt='레몬 답' />
              <input
                type='text'
                name='lemon'
                value={inputValue2}
            ...
            <span>
            <img src='/images/과일 산수 문제/당근답-.jpg' alt='딸기답' />
              <input
                type='text'
                name='apple'
                value={inputValue3}
