...
function Num_game10({ updateResult }) {
  ...
  return (
    <div className="Numgame">
      <div className='test'>
        <ul>
          <li>
           <img src='/images/과일 산수 문제/10.jpg' alt='문제 1' />
          </li>
          <li>
          <img src='/images/과일 산수 문제/10-1.jpg' alt='문제 1-1' />
          </li>
          <li>
          <img src='/images/과일 산수 문제/10-2.jpg' alt='문제 1-2' />
          </li>
