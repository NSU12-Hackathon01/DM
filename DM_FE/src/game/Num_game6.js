...
function Num_game6({ updateResult }) {
  ...
  return (
    <div className="Numgame">
      <div className='test'>
        <ul>
          <li>
           <img src='/images/과일 산수 문제/6.jpg' alt='문제 1' />
          </li>
          <li>
          <img src='/images/과일 산수 문제/6-1.jpg' alt='문제 1-1' />
          </li>
          <li>
          <img src='/images/과일 산수 문제/6-2.jpg' alt='문제 1-2' />
          </li>
          <li className='num_result'>
            <span>
              <img src='/images/과일 산수 문제/대파답-.jpg' alt='당근 답' />
              <input
                type='text'
                name='carrot'
                value={inputValue1}
            ...
            <span>
            <img src='/images/과일 산수 문제/옥수수답-.jpg' alt='레몬 답' />
              <input
                type='text'
                name='lemon'
                value={inputValue2}
