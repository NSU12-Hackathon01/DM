...
function Num_game2({ updateResult }) {
  ...
  return (
    <div className="Numgame">
      <div className='test'>
        <ul>
          <li>
           <img src='/images/과일 산수 문제/2.jpg' alt='문제 1' />
          </li>
          <li>
          <img src='/images/과일 산수 문제/2-1.jpg' alt='문제 1-1' />
          </li>
          <li>
          <img src='/images/과일 산수 문제/2-2.jpg' alt='문제 1-2' />
          </li>
          <li className='num_result'>
            ...
            <span>
            <img src='/images/과일 산수 문제/대파답-.jpg' alt='레몬 답' />
              <input
                type='text'
                name='lemon'
                value={inputValue2}
            ...
            <span>
            <img src='/images/과일 산수 문제/옥수수답-.jpg' alt='사과 답' />
              <input
                type='text'
                name='apple'
                value={inputValue3}
