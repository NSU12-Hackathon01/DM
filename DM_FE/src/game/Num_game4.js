...
function Num_game4({ updateResult }) {
  ...
  return (
    <div className="Numgame">
      <div className='test'>
        <ul>
          <li>
           <img src='/images/과일 산수 문제/4.jpg' alt='문제 1' />
          </li>
          <li>
          <img src='/images/과일 산수 문제/4-1.jpg' alt='문제 1-1' />
          </li>
          <li>
          <img src='/images/과일 산수 문제/4-2.jpg' alt='문제 1-2' />
          </li>
